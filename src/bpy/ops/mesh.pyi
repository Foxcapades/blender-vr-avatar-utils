...
# noinspection PyUnusedLocal
def average_normals(
    average_type: typing.Literal['CUSTOM_NORMAL', 'FACE_AREA', 'CORNER_ANGLE'] = 'CUSTOM_NORMAL',
    weight: int = 50,
...
# noinspection PyUnusedLocal
def bevel(
    offset_type: typing.Literal['OFFSET', 'WIDTH', 'DEPTH', 'PERCENT', 'ABSOLUTE'] = 'OFFSET',
    offset: float = 0.0,
    profile_type: typing.Literal['SUPERELLIPSE', 'CUSTOM'] = 'SUPERELLIPSE',
    offset_pct: float = 0.0,
    segments: int = 1,
    profile: float = 0.5,
    affect: typing.Literal['VERTICES', 'EDGES'] = 'EDGES',
    ...
    miter_inner: typing.Literal['SHARP', 'ARC'] = 'SHARP',
    spread: float = 0.1,
...
def bridge_edge_loops(
    type: typing.Literal['SINGLE', 'CLOSED', 'PAIRS'] = 'SINGLE',
    use_merge: bool = False,
    merge_factor: float = 0.5,
    twist_offset: int = 0,
    number_cuts: int = 0,
    interpolation: typing.Literal['LINEAR', 'PATH', 'SURFACE'] = 'PATH',
...
def delete(type: typing.Literal['VERT', 'EDGE', 'FACE', 'EDGE_FACE', 'ONLY_FACE'] = 'VERT') -> set[OperatorReturn]:
    """
...
# noinspection PyUnusedLocal
def edge_split(type: typing.Literal['EDGE', 'VERT'] = 'EDGE') -> set[OperatorReturn]:
    """
...
# noinspection PyUnusedLocal
def faces_mirror_uv(direction: typing.Literal['POSITIVE', 'NEGATIVE'] = 'POSITIVE', precision: int = 3) -> set[OperatorReturn]:
    """
...
# noinspection PyUnusedLocal
def intersect(
    mode: typing.Literal['SELECT', 'SELECT_UNSELECT'] = 'SELECT_UNSELECT',
    separate_mode: typing.Literal['ALL', 'CUT', 'NONE'] = 'CUT',
    threshold: float = 1e-06,
    solver: typing.Literal['FAST', 'EXACT'] = 'EXACT',
) -> set[OperatorReturn]:
    """
...
def intersect_boolean(
    operation: typing.Literal['INTERSECT', 'UNION', 'DIFFERENCE'] = 'DIFFERENCE',
    use_swap: bool = False,
    use_self: bool = False,
    threshold: float = 1e-06,
    solver: typing.Literal['FAST', 'EXACT'] = 'EXACT',
...
def knife_tool(
    ...
    xray: bool = True,
    visible_measurements: typing.Literal['NONE', 'BOTH', 'DISTANCE', 'ANGLE'] = 'NONE',
    angle_snapping: typing.Literal['NONE', 'SCREEN', 'RELATIVE'] = 'NONE',
...
# noinspection PyUnusedLocal,PyShadowingBuiltins
def merge(
    type: typing.Literal['CENTER', 'CURSOR', 'COLLAPSE', 'FIRST', 'LAST'] = 'CENTER',
    uvs: bool = False,
) -> set[OperatorReturn]:
    """
...
def mod_weighted_strength(
    set: bool = False,
    face_strength: typing.Literal['WEAK', 'MEDIUM', 'STRONG'] = 'MEDIUM',
) -> set[OperatorReturn]:
    """
...
# noinspection PyUnusedLocal
def normals_tools(
    mode: typing.Literal['COPY', 'PASTE', 'ADD', 'MULTIPLY', 'RESET'] = 'COPY',
    absolute: bool = False,
) -> set[OperatorReturn]:
    """
...
# noinspection PyUnusedLocal
def point_normals(
    mode: typing.Literal['COORDINATES', 'MOUSE'] = 'COORDINATES',
    invert: bool = False,
    align: bool = False,
...
def poke(
    offset: float = 0.0,
    use_relative_offset: bool = False,
    center_mode: typing.Literal['MEDIAN_WEIGHTED', 'MEDIAN', 'BOUNDS'] = 'MEDIAN_WEIGHTED',
) -> set[OperatorReturn]:
    """
...
def primitive_circle_add(
    vertices: int = 32,
    radius: float = 1.0,
    fill_type: typing.Literal['NOTHING', 'NGON', 'TRIFAN'] = 'NOTHING',
    calc_uvs: bool = True,
    enter_editmode: bool = False,
    align: typing.Literal['WORLD', 'VIEW', 'CURSOR'] = 'WORLD',
...
# noinspection PyUnusedLocal
def select_all(action: typing.Literal['TOGGLE', 'SELECT', 'DESELECT', 'INVERT'] = 'TOGGLE') -> set[OperatorReturn]:
    """
...
def select_mode(
    ...
    action: typing.Literal['DISABLE', 'ENABLE', 'TOGGLE'] = 'TOGGLE',
) -> set[OperatorReturn]:
    """
...
def select_random(
    ratio: float = 0.5,
    seed: int = 0,
    action: typing.Literal['SELECT', 'DESELECT'] = 'SELECT',
) -> set[OperatorReturn]:
    """
...
def select_similar(
    ...
    compare: typing.Literal['EQUAL', 'GREATER', 'LESS'] = 'EQUAL',
    threshold: float = 0.0,
) -> set[OperatorReturn]:
    """
...
def separate(type: typing.Literal['SELECTED', 'MATERIAL', 'LOOSE'] = 'SELECTED') -> set[OperatorReturn]:
    """
...
def shortest_path_pick(
    edge_mode: typing.Literal['SELECT', 'SEAM', 'SHARP', 'CREASE', 'BEVEL', 'FREESTYLE'] = 'SELECT',
...
def sort_elements(
    ...
    elements: set[typing.Literal['VERT', 'EDGE', 'FACE']] = set('VERT'),
    reverse: bool = False,
    seed: int = 0,
) -> set[OperatorReturn]:
    """
...
__all__ = [
    'attribute_set', 'average_normals', 'beautify_fill', 'bevel', 'bisect', 'blend_from_shape', 'bridge_edge_loops',
    'colors_reverse', 'colors_rotate', 'convex_hull', 'customdata_custom_splitnormals_add',
    'customdata_custom_splitnormals_clear', 'customdata_mask_clear', 'customdata_skin_add', 'customdata_skin_clear',
    'decimate', 'delete', 'delete_edgeloop', 'delete_loose', 'dissolve_degenerate', 'dissolve_edges', 'dissolve_faces',
    'dissolve_limited', 'dissolve_mode', 'dissolve_verts', 'dupli_extrude_cursor', 'duplicate', 'duplicate_move',
    'edge_collapse', 'edge_face_add', 'edge_rotate', 'edge_split', 'edgering_select', 'edges_select_sharp',
    'extrude_context', 'extrude_context_move', 'extrude_edges_indiv', 'extrude_edges_move', 'extrude_faces_indiv',
    'extrude_faces_move', 'extrude_manifold', 'extrude_region', 'extrude_region_move', 'extrude_region_shrink_fatten',
    'extrude_repeat', 'extrude_vertices_move', 'extrude_verts_indiv', 'face_make_planar', 'face_set_extract',
    'face_split_by_edges', 'faces_mirror_uv', 'faces_select_linked_flat', 'faces_shade_flat', 'faces_shade_smooth',
    'fill', 'fill_grid', 'fill_holes', 'flip_normals', 'flip_quad_tessellation', 'hide', 'inset', 'intersect',
    'intersect_boolean', 'knife_project', 'knife_tool', 'loop_multi_select', 'loop_select', 'loop_to_region', 'loopcut',
    'loopcut_slide', 'mark_freestyle_edge', 'mark_freestyle_face', 'mark_seam', 'mark_sharp', 'merge', 'merge_normals',
    'mod_weighted_strength', 'normals_make_consistent', 'normals_tools', 'offset_edge_loops', 'offset_edge_loops_slide',
    'paint_mask_extract', 'paint_mask_slice', 'point_normals', 'poke', 'polybuild_delete_at_cursor',
    'polybuild_dissolve_at_cursor', 'polybuild_extrude_at_cursor_move', 'polybuild_face_at_cursor',
    'polybuild_face_at_cursor_move', 'polybuild_split_at_cursor', 'polybuild_split_at_cursor_move',
    'polybuild_transform_at_cursor', 'polybuild_transform_at_cursor_move', 'primitive_circle_add', 'primitive_cone_add',
    'primitive_cube_add', 'primitive_cube_add_gizmo', 'primitive_cylinder_add', 'primitive_grid_add',
    'primitive_ico_sphere_add', 'primitive_monkey_add', 'primitive_plane_add', 'primitive_torus_add',
    'primitive_uv_sphere_add', 'quads_convert_to_tris', 'region_to_loop', 'remove_doubles', 'reveal', 'rip', 'rip_edge',
    'rip_edge_move', 'rip_move', 'screw', 'select_all', 'select_axis', 'select_by_attribute', 'select_face_by_sides',
    'select_interior_faces', 'select_less', 'select_linked', 'select_linked_pick', 'select_loose', 'select_mirror',
    'select_mode', 'select_more', 'select_next_item', 'select_non_manifold', 'select_nth', 'select_prev_item',
    'select_random', 'select_similar', 'select_similar_region', 'select_ungrouped', 'separate',
    'set_normals_from_faces', 'set_sharpness_by_angle', 'shape_propagate_to_all', 'shortest_path_pick',
    'shortest_path_select', 'smooth_normals', 'solidify', 'sort_elements', 'spin', 'split', 'split_normals',
    'subdivide', 'subdivide_edgering', 'symmetrize', 'symmetry_snap', 'tris_convert_to_quads', 'unsubdivide',
    'uv_texture_add', 'uv_texture_remove', 'uvs_reverse', 'uvs_rotate', 'vert_connect', 'vert_connect_concave',
    'vert_connect_nonplanar', 'vert_connect_path', 'vertices_smooth', 'vertices_smooth_laplacian', 'wireframe',
]
