...
from c import Collection, CollisionSettings, Context, CyclesObjectSettings
...
class Operator(bpy_struct):  # NEW REGEX
    ...
    @classmethod
    def poll(cls, context: Context) -> bool: pass

    def execute(self, context: Context) -> set[OperatorReturn]: pass

    def check(self, context: Context) -> bool: pass

    # TODO: what type is 'event'?
    def invoke(self, context: Context, event) -> set[OperatorReturn]: pass

    # TODO: what type is 'event'?
    def modal(self, context: Context, event) -> set[OperatorReturn]: pass

    def draw(self, context: Context) -> None: pass

    def cancel(self, context: Context) -> None: pass

    # TODO: what type is 'properties'?
    @classmethod
    def description(cls, context: Context, properties) -> str: pass
